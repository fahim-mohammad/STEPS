                ...
                <div className="rounded-md border p-3 text-xs">
                  ...
                  <p className="mt-2 text-muted-foreground">
                    {payload.status === 'VALID'
                      ? t(
                          'This receipt is authentic and matches our system records.',
                          'এই রসিদটি আসল এবং সিস্টেম রেকর্ডের সাথে মিলে গেছে।'
                        )
                      : t(
                          'This receipt does NOT match our system records (it may be modified).',
                          'এই রসিদটি সিস্টেম রেকর্ডের সাথে মেলে না (পরিবর্তিত হতে পারে)।'
                        )}
                  </p>
                </div>
              </div>
